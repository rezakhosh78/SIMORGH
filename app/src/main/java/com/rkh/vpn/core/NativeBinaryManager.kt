 ...
 *   app/src/main/jniLibs/<abi>/libstormdns.so
...
class NativeBinaryManager(private val context: Context) {
    ...
    fun prepare(binaryName: String): File {
        ...
        throw IllegalStateException(
            "Missing packaged native binary: app/src/main/jniLibs/$abi/$nativeName. " +
                ...
                "Run Gradle preBuild/native setup before build, or manually put $binaryName renamed to $nativeName in app/src/main/jniLibs/$abi/. " +
