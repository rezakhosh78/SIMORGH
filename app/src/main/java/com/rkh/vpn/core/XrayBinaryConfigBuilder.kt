...
object XrayBinaryConfigBuilder {
    fun socksConfigFromRaw(raw: String, socksPort: Int = 18188, forceGoogleDns: Boolean = false): String {
        ...
        if (serverLessInput) {
            ...
            // v2rayNG's HEV TUN feature and port 18188; that architecture is:
            // Android VpnService TUN -> tun2socks/HEV -> Xray mixed inbound :18188.
    ...
    fun hiddifyLikeBalancedSocksConfigFromRawList(raws: List<String>, socksPort: Int = 18188, forceGoogleDns: Boolean = true): String {
    ...
    fun nipoBridgeConfig(localSocksPort: Int = 18188, nipoSocksPort: Int = 9992): String {
        val socksInbound = JSONObject().apply {
            put("tag", "socks-in")
            put("listen", "127.0.0.1")
