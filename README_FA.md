...
**SIMORGH VPN** یک کلاینت اندرویدی چندموتوره برای اتصال در شرایط عادی، محدودیت اینترنت، نت ملی ایران، قطعی اینترنت بین‌الملل و استفاده از کانفیگ‌های XRAY و NipoVPN است.
